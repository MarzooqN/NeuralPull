...
class Runner:
    ...
    def validate_mesh(self, resolution=64, threshold=0.0, point_gt=None, iter_step=0, logger=None):
        ...
        mesh.export(os.path.join(self.base_exp_dir, 'outputs', '{}_{:0>8d}_{}.ply'.format(self.dataname, self.iter_step, str(threshold))))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu', type=int, default=0)  # GPU arg remains but is ignored
